...
namespace LevelEditor.Engine.Models.Primitives
{
    class SkySphere : Model
    {
        ...
        public SkySphereMaterial material;
        ...
        public SkySphere(float radius, int detail) : base()
        {
            Name = "Sky";
            Detail = detail;
            ...
            if (setupGeometry())
            {
                Log.WriteLine("Sky sphere '" + Name + "' loaded " +
        ...
        private int addVertex(Vector3 p)
        {
            ...
            normals.Add(-n); // inward for sky sphere
            return index++;
        }
